...
interface NeedsMintingStatusProps {
...
export default function NeedsMintingStatus({
  order,
  orderId,
  logo,
}: NeedsMintingStatusProps) {
  return (
      ...
      <Card className="mx-auto max-w-lg">
        <CardHeader className="text-center">
          ...
          <p className="text-gray-600 mt-2">
            Your payment has been received and is being processed. Tokens will
            be minted shortly.
          </p>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-blue-600 font-semibold">Needs Minting</span>
            </div>
            <div className="flex justify-between items-center">
