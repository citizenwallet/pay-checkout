      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Click on any color above to change the theme. The URL will update
              with the <code>color</code> parameter.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              The <code>ColorProvider</code> component converts the hex color to
              HSL format and sets CSS custom properties like{" "}
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Tailwind CSS uses these CSS variables to generate utility classes
              like <code>bg-primary</code>, <code>text-primary</code>, etc.
            </p>
          </div>
        </CardContent>
      </Card>
